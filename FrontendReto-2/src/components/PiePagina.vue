...
<template>
  <footer class="w-full py-8 px-4 text-white footer-gradient">
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <nav aria-label="Enlaces del pie de página">
        ...
        <ul class="grid grid-cols-2 gap-y-2 gap-x-4 text-sm">
          <li>
            <router-link to="/"
              class="hover:text-pink-300 transition-colors duration-300 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:text-pink-300">
              Inicio
            </router-link>
          </li>
          <li>
          ...
          <li v-if="!usuario">
            <button @click="$emit('abrirModal')"
              class="hover:text-pink-300 transition-colors duration-300 text-left cursor-pointer rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:text-pink-300">
              Iniciar sesión
            </button>
          </li>
        </ul>
      ...
      <div>
        ...
        <div class="flex gap-4 text-xl">
          <a href="https://es-es.facebook.com/" target="_blank" rel="noopener noreferrer"
            ...
            class="hover:scale-110 transition-all duration-300 size-5 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-white">
          ...
          <a href="https://x.com/" target="_blank" rel="noopener noreferrer" aria-label="Visitar nuestro Twitter"
            class="hover:scale-110 transition-all duration-300 size-5 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-white">
            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
              fill="currentColor">
              <path
...
.footer-gradient {
  ...
  --color-footer-end: #d63384;
  background: linear-gradient(90deg, var(--color-footer-start) 0%, var(--color-footer-end) 100%);
}
</style>